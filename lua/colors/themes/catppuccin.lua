return function()
local colors = {
	bg = "#1E1E28",          -- Mocha base
	fg = "#D9E0EE",          -- Text
	selection_bg = "#302D41", -- Selection
	selection_fg = "#F5C2E7", -- Pinkish highlight
	inactive_fg = "#6E6C7E", -- Muted
	positive = "#ABE9B3",    -- Green
	negative = "#F28FAD",    -- Red
	neutral = "#FAE3B0",     -- Yellow
	link = "#96CDFB",        -- Blue
	bar_bg = "#1A1826",      -- Bar background
	bar_fg = "#D9E0EE",
}
