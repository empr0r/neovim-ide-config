return function()
local colors = {
	bg = "#2b3339",            -- Deep forest
	fg = "#d3c6aa",            -- Birch bark
	selection_bg = "#4b565c",  -- Moss
	selection_fg = "#d3c6aa",  -- Birch bark
	inactive_fg = "#7fbbb3",   -- Frosted leaves
	positive = "#a7c080",      -- Fern green
	negative = "#e67e80",      -- Poison berry
	neutral = "#dbbc7f",       -- Golden oak
	link = "#83c092",          -- Sage teal
	bar_bg = "#1e2326",        -- Soil
	bar_fg = "#d3c6aa",
}
