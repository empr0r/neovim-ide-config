return function()
local colors = {
	bg = "#3f4a3e",            -- Moonlit mist green
	fg = "#e7e4cf",            -- Leaf cream
	selection_bg = "#4c5749",  -- Tea shadows
	selection_fg = "#fbf6e8",  -- Pale parchment
	inactive_fg = "#9da596",   -- Fog on moss
	positive = "#b7d99e",      -- Soft stem
	negative = "#e27d90",      -- Blush blossom
	neutral = "#e8c982",       -- Golden oat
	link = "#a4c8e4",          -- Porcelain reflection
	bar_bg = "#323d31",        -- Wet stone
	bar_fg = "#e7e4cf",
}
