...
local colors = {
	...
	fg = "#D8DEE9",            -- Snow Storm foreground
	selection_bg = "#434C5E",  -- Slightly lighter polar night
	selection_fg = "#ECEFF4",  -- Bright highlight text
	inactive_fg = "#4C566A",   -- Frosty gray for comments
	positive = "#A3BE8C",      -- Frost green (strings, success)
	negative = "#BF616A",      -- Frost red (errors, keywords)
	neutral = "#EBCB8B",       -- Frost yellow (warnings)
	link = "#81A1C1",          -- Frost blue (functions)
	bar_bg = "#3B4252",        -- Darker status/tabline
	bar_fg = "#D8DEE9",
}
